  ...
  return (
    <>
      ...
      <div className="grid lg:grid-cols-2 gap-1 md:gap-10 pb-10">
        ...
        />
        <Project
          description="This portfolio created with NEXT.js, tailwindcss and TypeScript"
          websiteLink="https://my-portfolio-topaz-ten.vercel.app/"
          codeLink="https://github.com/NicoLindenau/my-portfolio"
          img={portfolio}
          imgAlt="my portfolio"
        />
        <Project
